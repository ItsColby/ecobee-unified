...
| F-09 | Expose compact live provenance, source health, and command-confirmation status; keep exact continuously advancing source and command ages in bounded diagnostics. |
